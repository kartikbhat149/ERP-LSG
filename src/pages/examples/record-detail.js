...
import RecordDetailView from "../../examples/record-detail-view"

export default function RecordDetailExample() {
  ...
  page.innerHTML = `
    <div>
      ...
      <p class="text-sm text-text-muted">
        Standard ERP record inspection page with summary
